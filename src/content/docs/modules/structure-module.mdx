...
Configure how entries appear in list/grid views:
...
| Setting | Description |
|---------|-------------|
| Navigation style | Tabs, Sidebar, or None |
...
1. **Header** - Node icon, name, and action buttons (favourite, menu)
2. **Breadcrumbs** - Dynamic breadcrumbs in the site header showing `Type (plural) > Node Name`
3. **Tab Navigation** - Horizontal tabs
