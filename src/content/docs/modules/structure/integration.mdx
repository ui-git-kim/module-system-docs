...
Admins can control module-provided content per node type via the **Integrations** tab in the node type form (Structure Types > Edit Type > Integrations). This means your module's tabs, widgets, and card extensions can be:
