...
The code generator is fully config-driven — it uses `codePlacement`, `codeAlias`, and `codeFormat` from property definitions to determine output. There are no hardcoded property key or component type checks.
