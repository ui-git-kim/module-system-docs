...
- **Preview Panel** (top centre) — live render of your block in an iframe using pristine shadcn components, compiled with Sucrase at runtime. Supports responsive viewport switching (desktop, tablet, mobile) with a dot-grid background.
