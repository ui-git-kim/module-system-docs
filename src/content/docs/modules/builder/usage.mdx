...
Accessed via **Admin > Block Builder** (`/admin/block-builder`, admin role only). Full CRUD interface for managing native component definitions, field templates, and module settings. See the [Configuration](/modules/builder/configuration/#admin-page) page for details.
