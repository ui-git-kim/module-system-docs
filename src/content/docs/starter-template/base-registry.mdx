...
All registries follow this general ordering convention:
...
<Aside type="note">
Some registries have specific conventions documented in their source files. For example, `headerToolbarRegistry` uses 1-20 for primary actions, 41-60 for notifications, etc. Check the registry file for details.
</Aside>
