---
title: CLI Scripts
description: Documentation for the create-app and update-template scripts
---

The starter template includes scripts for creating new apps and keeping them updated with template changes.
