...
```tsx
// SiteHeader.tsx
<header className="flex h-(--header-height) items-center border-b transition-[width,height]">
  <div className="flex w-full items-center px-4 lg:px-6">
    {/* Left: Sidebar trigger + Breadcrumbs */}
    <div className="flex items-center gap-2">
      {/* Sidebar trigger + separator are hidden when a FullBleed
          page sets collapsible mode */}
      {!isFullBleedCollapsible && (
        <>
...
| **Sidebar sections** | Admin → Navigation | Create/edit sections, assign items |
| **Hide toolbar items** | Admin → Toolbar | Items hidden from header |
| **App branding** | Admin → Branding | Logo, name, display mode |
