...
|------|-------|-------------|
| Settings | `/settings` | User settings (profile, preferences) |
...
const filteredMainItems = applyNavigationOverrides(
  mainItems,
  settings.navigationOverrides,
  settings.showDashboardInNav
);
```
