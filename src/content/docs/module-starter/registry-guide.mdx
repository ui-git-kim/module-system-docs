...
Other types: `toggle` (on/off state), `dropdown` (opens a menu), `custom` (full component).
...
All registries use a **0-100 scale**. Lower numbers appear first. The default is `50`.
