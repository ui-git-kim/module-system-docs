...
Modules use registration files to add themselves to the app's registries. For the full API reference for each registry, see the [Registry Reference](/starter-template/registries/).
