...
These templates are ready to copy into your module's `src/templates/` directory. Remember to use `my-feature` as the placeholder—it gets replaced with the actual module name during installation.
